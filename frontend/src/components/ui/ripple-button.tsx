...
const RippleButton: React.FC<RippleButtonProps> = ({
  ...
  rippleDuration = 600,
  hoverBaseColor = '#2b7fff',
  hoverRippleColor: customHoverRippleColor,
  hoverBorderEffectColor = '#2b7fff77',
  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: JS_RIPPLE_KEYFRAMES }} />
      <button className={`${baseClasses} ${disabledClasses} ${className}`} onClick={handleButtonClick} disabled={disabled}>
