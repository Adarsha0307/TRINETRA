...
import { Shield, LayoutDashboard, Link2, Mail, MessageSquare, QrCode, History, ShieldAlert } from 'lucide-react';
...
const NAV = [
  ...
  { to: '/sandbox', label: 'Threat Sandbox', icon: ShieldAlert, testid: 'nav-sandbox' },
